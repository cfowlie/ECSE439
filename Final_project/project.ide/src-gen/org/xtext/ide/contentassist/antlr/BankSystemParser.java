...
public class BankSystemParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BankSystemGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBankAccess().getNameAssignment_3(), "rule__Bank__NameAssignment_3");
			builder.put(grammarAccess.getBankAccess().getCountryOfOriginAssignment_5(), "rule__Bank__CountryOfOriginAssignment_5");
			builder.put(grammarAccess.getBankAccess().getBranchesAssignment_6(), "rule__Bank__BranchesAssignment_6");
			builder.put(grammarAccess.getBankAccess().getAccountsAssignment_7(), "rule__Bank__AccountsAssignment_7");
			builder.put(grammarAccess.getBankAccess().getTransactionsAssignment_8(), "rule__Bank__TransactionsAssignment_8");
			...
			builder.put(grammarAccess.getEmployeeAccess().getNameAssignment_3(), "rule__Employee__NameAssignment_3");
			builder.put(grammarAccess.getEmployeeAccess().getDateAssignment_5(), "rule__Employee__DateAssignment_5");
			builder.put(grammarAccess.getEmployeeAccess().getSalaryAssignment_7(), "rule__Employee__SalaryAssignment_7");
			builder.put(grammarAccess.getEmployeeAccess().getCurrentRoleAssignment_9(), "rule__Employee__CurrentRoleAssignment_9");
			builder.put(grammarAccess.getAccountAccess().getAccountNumAssignment_3(), "rule__Account__AccountNumAssignment_3");
			builder.put(grammarAccess.getAccountAccess().getHolderAssignment_5(), "rule__Account__HolderAssignment_5");
			builder.put(grammarAccess.getAccountAccess().getBalanceAssignment_7(), "rule__Account__BalanceAssignment_7");
			...
			builder.put(grammarAccess.getAccountAccess().getDebPerMonthAssignment_13_1(), "rule__Account__DebPerMonthAssignment_13_1");
